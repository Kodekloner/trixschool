...
result_summary_panel_assert(strpos($statistics, 'NO.:') !== false && strpos($statistics, '>27<') !== false, 'Statistics mode must render number in class.');
...
result_summary_panel_assert(strpos($gradeKey, 'NO.:') === false && strpos($gradeKey, 'Promotion status') === false, 'Grade-key mode must not duplicate statistics or promotion content.');
...
result_summary_panel_assert(strpos($promotion, 'NO.:') === false && strpos($promotion, 'Key to grades') === false, 'Promotion mode must not duplicate statistics or grade-key content.');
...
result_summary_panel_assert(strpos($qualitativeStatistics, 'NO.:') !== false && strpos($qualitativeStatistics, '>14<') !== false, 'British and kindergarten statistics must retain number in class.');
