...
<body style="background: rgb(236, 234, 234);">
                    ...
                    <div class="row" style="margin: 15px;">
                        <div class="col-sm-4 col-md-4">
                            <div>
                                ...
                                <h3 style="margin-bottom: 50px;">Create CA</h3>

                                <form>
                                    <div class="form-group">
                                        <label for="CaTitle">CA Title</label>
                                    ...
                                    <div class="form-group">
                                        <select class="form-control" id="examNumber">
                                            <option>Select Number of CA</option>
                            ...
                            <div class="table-responsive data_table">
                                ...
                                <table id="example" class="table table-striped table-sm" style="width:100%;">
                                    ...
                                    <tbody>
                                        ...
                                        $sqlresultsetting = "SELECT * FROM `resultsetting`";
                                        ...
                                        if ($row_cntresultsetting > 0) {
                                            do {
                                                ...
                                                $resultsettingid = $rowresultsetting['ResultSettingID'];

                                                echo '
                    						                    <tr>
                                                                    <td>' . $rowresultsetting['CaTitle'] . '</td>';

                                                $sqlassigncatoclass = "SELECT * FROM `assigncatoclass` WHERE ResultSettingID='$resultsettingid'";
                                                ...
                                                echo '<td>' . $row_cntassigncatoclass . '</td>
                                    								<td>
                                                                        <button style="color: #000000; margin-left: 10px;border:none;" data-id="' . $rowresultsetting['ResultSettingID'] . '" data-resulttype="' . $rowresultsetting['ResultSettingID'] . '" id="addstudentbtn">
                                                                        ...
                                                                        <button style="color: #000000; margin-left: 10px;border:none;" data-numca="' . $rowresultsetting['NumberOfCA'] . '" data-id="' . $rowresultsetting['CaTitle'] . '" id="editsubjectbtn">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 style="margin-left: 25%;" class="modal-title" id="exampleModalLabel">Assign CA to Class</h4>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
    ...
    <script>
        ...
        $("body").on("click", "#addstudentbtn", function() {
            ...
            // alert(dataString);
            $.ajax({
                url: '../../../phpscript/get-class-assigned.php',
                method: 'POST',
                data: dataString,
        ...
        $("body").on('change', '#examNumber', function() {
            ...
            $.ajax({
                url: '../../../phpscript/resultsettingsload.php',
                method: 'POST',
        ...
        $("body").on("click", "#submitstudentbtn", function() {
            ...
            if (resultsettingid != '' && resultsettingid != '0' && classid.length > 0) {
                ...
                // alert(dataString);
                $.ajax({
                    url: '../../../phpscript/insert-studentexam.php',
                    method: 'POST',
                    data: dataString,
