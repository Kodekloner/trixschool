...
<html lang="en">
  <head>
    ...
    <title>Psycomotor Setting</title>
  </head>
                    		...
                    		<div class="row" style="margin: 15px;">
                                <div class="col-sm-4 col-md-4">
                    				<div>
                    					...
                    					<h3 style="margin-bottom: 50px;">Create Psycomotors</h3>
                    
                    					<form>
                    						<div class="form-group">
                    						  <label for="CaTitle">Psycomotors Title</label>
                    						...
                    						<div class="form-group">
                                                <select class="form-control" id="examNumber">
                                                    <option>Select Number of Psycomotors</option>
                    					...
                    					<table id="example" class="table table-striped table-sm"  style="width:100%;">
                    						...
                    						<tbody>
                    						    <?php
                                                    ...
                                                    $sqlresultsetting = "SELECT * FROM `psycomotor_settings`";
                                                    ...
                                                    if($row_cntresultsetting > 0)
                                                    {
                                                        do{
                                                            ...
                                                            echo'
                    						                    <tr>
                                                                    <td>'.$rowresultsetting['PTitle'].'</td>';
                                                                    
                                    								$sqlassignsaftoclass = "SELECT * FROM `assignspsycomotortoclass` WHERE PsycomotorSettingsId='$resultsettingid'";
                                    								...
                                    								<td>
                                                                        ...
                                                                        <button style="color: #000000; margin-left: 10px;border:none;" data-numca="'.$rowresultsetting['NumberofP'].'" data-id="'.$rowresultsetting['PTitle'].'" id="editsubjectbtn">
                                                                        ...
                                                                        '; ?>
                                                                     <a data-placement="left" href="feenext/psycomotor_delete/<?php echo $resultsettingid; ?>"class="btn btn-default btn-xs"  data-toggle="tooltip" title="" onclick="return confirm('Proceed and Delete')">
                                ...
                                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <h4 style="margin-left: 25%;" class="modal-title" id="exampleModalLabel">Assign Psycomotors to Class</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
    ...
    <script>
        ...
        $("body").on("click", "#addstudentbtn", function(){
            ...
            var dataString = 'resultsettingid=' + resultsettingid;
                ...
                // alert(dataString);
            $.ajax({
                url: '../../../phpscript/psycomotor/get-class-assignedtopsycomotor.php',
                method:'POST',
                data:dataString,
                ...
                if(examNumber == '1')
                {
                    ...
                    else
                    {
                        ...
                        $.each($("input[name='selForMidTerm']:checked"), function(){
                            ...
                            $.ajax({
                                url: '../../../phpscript/psycomotor/updatepsycomotorsettings.php',
                                method:'POST',
                                data:dataString,
                ...
                else if(examNumber == '15')
                {
                    ...
                    else
                    {
                        ...
                        // alert(selectedcaformidterm);
                            ...
                            $.ajax({
                                url: '../../../phpscript/updatepsycomotorsettings.php',
                                method:'POST',
                                data:dataString,
        ...
        $("body").on('change','#examNumber',function(){
            ...
            $.ajax({
                    url: '../../../phpscript/psycomotor/psycomotorsettingsload.php',
                    method:'POST',
        ...
        $("body").on("click", "#submitstudentbtn", function(){
            ...
            if(resultsettingid != '' && resultsettingid != '0' && classid.length > 0)
            {
                ...
                // alert(dataString);
                $.ajax({
                    url: '../../../phpscript/psycomotor/insert-psycomotor.php',
                    method:'POST',
                    data:dataString,
