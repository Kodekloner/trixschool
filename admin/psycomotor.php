       	...
       	<div class="sidebar-header">
            ...
            <div class="col-sm-12 cardBoxSty">
				...
				<?php
						...
						<!--<div class="form-group col-sm">-->
						<!--	<select class="form-control" id="psycomotor">-->
						<!--		<option value="0">Psycomotor</option>-->
						<!--	</select>-->
						<!--</div>-->
								...
								<div class="col-12">
									<div class="card">
										<div class="card-body">
											...
											<h3 class="card-title">Online Result Psycomotor Computation</h3>
    ...
    <script>
        ...
        $("body").on("click", "#getstud", function(){
            ...
            if(classid != '' && classid != '0' && classsectionactual != '' && classsectionactual != '0' && session != '' && session != '0' && term != '' && term != '0')
            {
                ...
                $.ajax({
                    url: '../../../phpscript/psycomotor/insert-studentspsycomotor.php',
                    method:'POST',
                    data:dataString,
                    ...
                    success: function(maindata2) {
                        ...
                        $.ajax({
                            url: '../../../phpscript/psycomotor/get-psycomotorstudents.php',
                            method:'POST',
                            data:dataString,
        ...
        $(document).on('change', '.edit_tr', function () {
            ...
            $.ajax({
                type: "POST",
                url: "../../../phpscript/psycomotor/updateStudentpsycomotorTable.php",
                data: dataString,
                cache: false,
        ...
        $('body').on('click','#delbtn',function () {
            ...
            $.ajax({
               type: "POST",
               url: "../../../phpscript/psycomotor/loadSingleScoreDelPrompt.php",
               data: dataString,
               cache: false,
        ...
        $(document).ready(function(){
            ...
            $("#ProcToDelSelScore").click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "../../../phpscript/psycomotor/ProceedToDelSingleScore.php",
                    data: dataString,
                    cache: false,
