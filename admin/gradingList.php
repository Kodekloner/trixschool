...
<body style="background: rgb(236, 234, 234);">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form>
                                        ...
                                        <div class="form-row" id="displayclasses"></div>
                                    </form>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <!-- jQuery, Bootstrap, DataTables etc. -->
    ...
    <script>
        // (Keep your existing JavaScript exactly as before)
        ...
        $("body").on("click", "#addstudentbtn", function() {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: 'GradingTitle=' + GradingTitle,
                success: function(maindata2) {
        ...
        // Sidebar toggle scripts (keep as is)
