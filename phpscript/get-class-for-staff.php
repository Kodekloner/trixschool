<?php
    ...
    $sqlsection = "SELECT classes.id AS classid,classes.class AS classname FROM `class_teacher` INNER JOIN classes ON class_teacher.class_id=classes.id WHERE class_teacher.staff_id='$staffid' AND class_teacher.session_id='$session' ORDER BY classname ASC";
