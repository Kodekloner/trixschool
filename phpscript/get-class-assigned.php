<?php 
    ...
    $sqlchecker = "SELECT * FROM `assigncatoclass` WHERE ResultSettingID='$resultsettingid' LIMIT 1";
           ...
           if($row_cntclass > 0)
           {
               ...
               do{    
                   ...
                   $class = $rowclass['id'];
                    ...
                    $sqlassigncatoclass = "SELECT * FROM `assigncatoclass` WHERE ClassID='$class' AND ResultSettingID='$resultsettingid'";
