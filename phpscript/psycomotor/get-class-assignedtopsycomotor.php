<?php 
    ...
    $sqlchecker = "SELECT * FROM `assignspsycomotortoclass` WHERE PsycomotorSettingsId='$resultsettingid' LIMIT 1";
           ...
           if($row_cntclass > 0)
           {
               ...
               do{    
                   ...
                   $class = $rowclass['id'];
                    ...
                    $sqlassigncatoclass = "SELECT * FROM `assignspsycomotortoclass` WHERE ClassID='$class' AND PsycomotorSettingsId='$resultsettingid'";
