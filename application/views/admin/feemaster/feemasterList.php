                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select  id="feetype_id" name="feetype_id" class="form-control" >
                                                ...
                                                foreach ($feetypeList as $feetype) {
                                                    ?>
                                                    <option occurence="<?php echo $feetype['occurence'] ?>" value="<?php echo $feetype['id'] ?>"<?php
										...
										<div class="form-group">
											<label for="exampleInputEmail1"><?php echo 'Term'; ?></label> <small class="req">*</small>
												<select name="term" required class="form-control">
													...
													<option value="first term" <?php if(set_value('term') == 'first term'){ echo "selected";}; ?> >First Term</option>
													<option value="second term" <?php if(set_value('term') == 'second term'){ echo "selected";}; ?> >Second Term</option>
													<option value="third term" <?php if(set_value('term') == 'third term'){ echo "selected";}; ?> >Third Term</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input occurence="" id="amount" name="amount" placeholder="" type="text" class="form-control"  value="<?php echo set_value('amount'); ?>" />
...
<script type="text/javascript">
    $(document).ready(function () {
		...
		$('#feetype_id').change(function () {
			value = $(this).val()
			if(value != ''){
				occurence = $('option:selected', this).attr('occurence')
				if(occurence == 'termly'){
					$('.dn').show()
					$('#amount').attr('occurence', 'termly')
				}else{
					$('.dn').hide()
					$('#first_amount').val('')
					$('#second_amount').val('')
					$('#third_amountval').val('')
					$('#amount').attr('occurence', '')
		...
		$('#amount').keyup(function () {
			occurence = $(this).attr('occurence')
			if(occurence == 'termly'){
				value = $(this).val()
				$('#first_amount').val(value)
				$('#second_amount').val(value)
				$('#third_amount').val(value)
			}
