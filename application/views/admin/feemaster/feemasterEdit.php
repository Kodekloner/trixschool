										...
										<div class="form-group">
											<label for="exampleInputEmail1"><?php echo 'Term'; ?></label> <small class="req">*</small>
												<select name="term" required class="form-control">
													...
													<option value="first term" <?php if(set_value('term', $feegroup_type->term) == 'first term'){ echo "selected";}; ?> >First Term</option>
													<option value="second term" <?php if(set_value('term', $feegroup_type->term) == 'second term'){ echo "selected";}; ?> >Second Term</option>
													<option value="third term" <?php if(set_value('term', $feegroup_type->term) == 'third term'){ echo "selected";}; ?> >Third Term</option>
