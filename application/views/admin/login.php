                                ...
                                <div class="loginbg loginradius login390">  
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        <form action="<?php echo site_url('site/login') ?>" method="post">
                                            ...
                                            <?php } ?>
                                            <button type="submit" id="loginbtn" class="btn"><?php echo $this->lang->line('sign_in'); ?></button>
                                        </form>
                                        <a href="<?php echo site_url('site/forgotpassword') ?>" class="forgot"><i class="fa fa-key"></i> <?php echo $this->lang->line('forgot_password'); ?>?</a>
                                        <div>
                                            <a href="<?php echo site_url('site/userlogin')?>"> <i class="fa fa-user" aria-hidden="true"></i> Student & Parent Login </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $('body').on('click','#loginbtn',function () {
        ...
        $.ajax({
            type: "POST",
            url: "../../../phpscript/startsession.php",
            data: 'username='+username+'&password='+password+'&utype='+utype,
