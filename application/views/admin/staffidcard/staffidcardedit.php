                                                ...
                                                <td class="mailbox-date pull-right no-print white-space-nowrap">
                                                  <a data-id="<?php echo $staffidcards_value->id ?>" class="btn btn-default btn-xs view_data"  data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>">
                                                    ...
                                                    if ($this->rbac->hasPrivilege('staff_id_card', 'can_delete')) {
                                                        ?>
                                                        <form method="post" action="<?php echo site_url('admin/staffidcard/delete/' . (int) $staffidcards_value->id); ?>" style="display:inline" onsubmit="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');">
                                                            <input type="hidden" name="idcard_legacy_csrf" value="<?php echo html_escape($idcard_legacy_csrf); ?>">
