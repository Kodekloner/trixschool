<?php $currency_symbol = $this->customlib->getSchoolCurrencysymbolwithalignment();  ?>
                ...
                <div class="nav-tabs-custom theme-shadow">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <form action="<?php echo site_url('admin/onlineadmission/admissionsetting') ?>" method="post" accept-charset="utf-8">
                                <div class="row">
                                        <label class="col-sm-5 control-label"><?php echo $this->lang->line('online') . " " . $this->lang->line('admission'); ?></label>
                                        <div class="col-sm-7">
                                            <div class="form-group">
                                                 <div class="material-switch">
                                                    <input id="exm_yes" name="online_admission" type="checkbox" data-role="field_" class="enableexam"   value="1" <?php echo set_checkbox('online_admission', '1', (set_value('online_admission', $result->online_admission ) == 1) ? TRUE : FALSE); ?>>
                                                      <label for="exm_yes" class="label-success"></label>
                                                 </div>
                                           </div>
                                        </div>
                                    <div  id="settingclm">
                                       <div id="paymentclm">
                                           <label class="col-sm-5"><?php echo $this->lang->line('online_admission_payment_option') ?></label>
                                           <div class="col-sm-7">
                                                <div class="form-group">
                                                    <div class="material-switch">
                                        ...
                                        <div id="amountclm">
                                            <label class="col-sm-5 control-label"><?php echo $this->lang->line('online_admission_form_fees').'('.$currency_symbol.')'  ?></label>
                                            <div class="col-sm-2">
                                                <div class="form-group">
                                                     <input type="text" name="online_admission_amount" id="online_admission_amount" class="form-control" value="<?php echo $result->online_admission_amount; ?> " onkeypress="return IsNumeric(event);" >
                        	...
                        	<div class="row">
	                            <div class="box-footer pull-right">
	                                <button type="submit" name="submitbtn" value="submitbtn" class="btn btn-primary"> <?php echo $this->lang->line('save'); ?></button>
                        ...
                        <div class="tab-pane" id="tab_2">
                            <form role="form" id="twilio" id="twilio" action="<?php echo site_url('smsconfig/twilio') ?>" class="" method="post">
                                <div class="">
                                    <div class="row">
                                            <div class="col-sm-10"> 
...
(function ($) {
 ...
 $(document).ready(function () {
        ...
        $(document).on('click', '#exm_yes', function(event) {      
