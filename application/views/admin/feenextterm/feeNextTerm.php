            ...
            if ($this->rbac->hasPrivilege('fees_type', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action="<?php echo base_url() ?>admin/feenext"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input autofocus="" id="name" name="name" type="text" class="form-control" required value="<?php echo set_value('name'); ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <select  id="class_id" name="class" class="form-control"  >
                                        ...
                                        foreach ($classlist as $class) {
                                            ?>
                                            <option value="<?php echo $class['id'] ?>"<?php if (set_value('class_id') == $class['id']) echo "selected=selected" ?>><?php echo 							 
  						$class['class'] ?></option>
                                            <?php
                                            $count++;
                                        }
					...
					<select name="term" required class="form-control">
						...
						<option value="1st" <?php if(set_value('term') == '1st'){ echo "selected";}; ?> >First Term</option>
						<option value="2nd" <?php if(set_value('term') == '2nd'){ echo "selected";}; ?> >Second Term</option>
						<option value="3rd" <?php if(set_value('term') == '3rd'){ echo "selected";}; ?> >Third Term</option>
					...
					<span class="text-danger"><?php echo form_error('term'); ?></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="code" name="amount" type="number" class="form-control" required value="<?php echo set_value('amount'); ?>" />
