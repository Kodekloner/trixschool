...
?>
<link rel="stylesheet" href="<?php echo base_url('backend/idcard-studio/idcard-studio.css?v=2.0.2'); ?>">
<script>
...
<script src="<?php echo base_url('backend/idcard-studio/idcard-studio.js?v=2.0.2'); ?>"></script>
