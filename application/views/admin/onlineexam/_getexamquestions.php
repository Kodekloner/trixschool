...
?>
        ...
        <ul class="nav nav-pills subject_pills pull-right mb10">
          <li class="active"><a href="#" data-subject-id="0">All</a></li>
          <?php   
...
<div class="question_row_<?php echo $question_value->onlineexam_question_id;?> subject_div_<?php echo $question_value->subject_id;?>" >
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-12">
                         ...
                         <div class="text text-danger pull-left">
               <!-- Button trigger modal -->
    <button type="button" class="btn btn-xs del_exam_questionssss" data-toggle="modal" data-target="#mydeleteModal" data-exam-id="<?php echo $exam->exam; ?>" data-onlineexam-question-id="<?php echo $question_value->onlineexam_question_id; ?>"><i class="fa fa-trash" aria-hidden="true"></i></button>
                        </div>
