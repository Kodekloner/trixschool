        ...
        <div class="box box-info">
            ...
            <div class="box-body table-responsive onlineexam-scroll">
                <table class="table table-striped table-bordered table-hover operations-wide-table">
                    <thead><tr><th>Candidate</th><th>Arm</th><th>Status</th><th>Official attempt</th><th style="min-width:300px">Accommodation</th></tr></thead>
                    <tbody>
        ...
        <div class="box box-warning">
            ...
            <div class="box-body table-responsive onlineexam-scroll">
                <table class="table table-striped table-bordered operations-table">
                    <thead><tr><th>Candidate</th><th>Attempt</th><th>Status</th><th>Saved/submitted</th><th>Theory review</th><th>Result sync</th><th>Actions</th></tr></thead>
                    <tbody>
                ...
                <div class="box box-default">
                    ...
                    <div class="box-body table-responsive onlineexam-scroll">
                        <table class="table table-bordered table-condensed operations-table">
                            <thead><tr><th>Candidate</th><th>Result component</th><th>Status</th><th>Posted/current</th><th>Reason</th></tr></thead>
                            <tbody>
                            <?php foreach ($sync_rows as $row) { ?>
                                <tr class="<?php echo $row['status'] === 'conflict' ? 'danger' : ($row['status'] === 'posted' ? 'success' : 'warning'); ?>">
                                    ...
                                    <td>
                                        ...
                                        <?php } ?>
                                        <?php if ($row['status'] === 'conflict' && in_array($row['adapter'], array('standard_component', 'holiday_assessment'), true)) { ?>
