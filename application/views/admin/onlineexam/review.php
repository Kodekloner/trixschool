...
.onlineexam-review .review-table { width:max-content; min-width:100%; table-layout:fixed; border-collapse:separate; border-spacing:0; }
.onlineexam-review .review-table th, .onlineexam-review .review-table td { min-width:170px; max-width:220px; width:190px; white-space:normal; overflow-wrap:anywhere; vertical-align:middle; }
...
.onlineexam-review .review-cell { display:block; width:100%; white-space:normal; min-height:40px; }
...
<div class="content-wrapper onlineexam-ui onlineexam-review">
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form method="get" action="<?php echo site_url('admin/onlineexam/review'); ?>" class="review-criteria" id="review-criteria">
                    ...
                    <button class="btn btn-primary" type="submit" id="review-search"><i class="fa fa-search" aria-hidden="true"></i> Show records</button>
                </form>
        ...
        <?php if ($ready) { ?>
            <div class="box box-primary">
                <div class="box-header with-border"><h3 class="box-title">Students and papers</h3></div>
                ...
                <?php } else { ?>
                    <div class="box-body">
                        <p class="text-muted">Select a student's paper to review their work, reschedule it or record a score.</p>
                            ...
                            <table class="table table-bordered review-table">
                                ...
                                <thead><tr><th scope="col" class="review-student">Student</th>
                                    <?php foreach ($review['columns'] as $column) { ?><th scope="col">
                                        ...
                                        <span class="review-subtitle"><?php echo html_escape($column['assessment']); ?></span>
                                        <span class="review-subtitle"><?php echo html_escape($column['title']); ?><?php echo $column['component'] ? ' · ' . html_escape($column['component']) : ''; ?></span>
                                    </th><?php } ?>
                                </tr></thead>
...
(function ($) {
    'use strict';
    var sectionsRequest = null, cellRequest = null;
    ...
    $('#review-session, #review-class').on('change', function () {
        ...
        sectionsRequest = $.getJSON(<?php echo json_encode(site_url('admin/onlineexam/reviewsections')); ?>, {session_id:$('#review-session').val(), class_id:$('#review-class').val()})
            .done(function (rows) {
                ...
                $('#review-search').prop('disabled', !rows.length);
