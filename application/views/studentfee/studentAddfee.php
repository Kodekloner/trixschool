...
?>
                        ...
                        <div class="row no-print">
                            <div class="col-md-12 mDMb10">
								...
								<a type="button" href="<?php echo $student['student_session_id'] . '?term=all'; ?>" class="btn btn-sm btn-success" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i>"><i class="fa fa-money"></i> <?php echo 'View All Fee'; ?></a>
								<a type="button" href="<?php echo $student['student_session_id'] ?>" class="btn btn-sm btn-primary" id="load" data-loading-text="<i class='fa fa-spinner fa-spin '></i>"><i class="fa fa-money"></i> <?php echo 'View Current Fee'; ?></a>
...
echo $fee_value->name . " (" . $fee_value->type . ")";
        ?></td>
                                                <td align="left"><?php echo strtoupper($fee_value->term); ?></td>
