                        ...
                        <form role="form" id="schsetting_form" action="<?php //echo site_url('schsettings/ajax_schedit_new')      ?>" class="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
									...
									<div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo 'Term'; ?><small class="req"> *</small></label>
                                            <div class="col-sm-8">
                                                <select  id="session_id" name="term" class="form-control" required>
                                                    <option value="">---- select term ----</option>
													<option <?php
                                                        if ($result->term == 'first term') {
                                                            echo "selected";
                                                        }
                                                        ?> value="first term">First Term</option>
													<option <?php
                                                        if ($result->term == 'second term') {
                                                            echo "selected";
                                                        }
                                                        ?> value="second term">Second Term</option>
													<option <?php
                                                        if ($result->term == 'third term') {
                                                            echo "selected";
                                                        }
                                                        ?> value="third term">Third Term</option>
