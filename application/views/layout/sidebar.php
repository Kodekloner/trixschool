<aside class=" main-sidebar" id="alert2">
    ...
    <section class="sidebar" id="sibe-box">
        ...
        <ul class="sidebar-menu verttop">
                ...
                ?>
                    <li class="treeview <?php echo set_Topmenu('Fees Collection'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('fees_type', 'can_view')) {
                            ?>
                                <li class="<?php echo set_Submenu('feenext/index'); ?>"><a href="<?php echo base_url(); ?>admin/feenext"><i class="fa fa-angle-double-right"></i> Next Term Fee</a></li>
                            <?php
                            }
                    ...
                    <li class="treeview <?php echo set_Topmenu('Attendance'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            ?>
                                    ...
                                    <li class="<?php echo set_Submenu('manualattendance/index'); ?>"><a href="<?php echo base_url(); ?>admin/manualattendance.php"><i class="fa fa-angle-double-right"></i> Manual Attendance</a></li>
            ...
            if ($this->module_lib->hasActive('exam_setting')) {
                if (($this->rbac->hasPrivilege('ca_setting', 'can_view') ||
                    $this->rbac->hasPrivilege('grading_list', 'can_view') ||
                    $this->rbac->hasPrivilege('affective_domain', 'can_view') ||
                    $this->rbac->hasPrivilege('psycomotor', 'can_view') ||
                    $this->rbac->hasPrivilege('compute_result', 'can_view') ||
                    $this->rbac->hasPrivilege('british_computation', 'can_view') ||
                    $this->rbac->hasPrivilege('Head_teacher_default_comment', 'can_view') ||
                    $this->rbac->hasPrivilege('Head_teacher_manual_comment', 'can_view') ||
                    $this->rbac->hasPrivilege('teachers_default_comment', 'can_view') ||
                    $this->rbac->hasPrivilege('teachers_manual_comment', 'can_view') ||
                    $this->rbac->hasPrivilege('resumption_date', 'can_view') ||
                    $this->rbac->hasPrivilege('results', 'can_view') ||
                    $this->rbac->hasPrivilege('broadsheet', 'can_view')
                )) {
                ?>
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-map-o ftlayer"></i> <span>Exam Setting</span> <i class="fa fa-angle-left pull-right"></i>
                        </a>
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('add_psycomotor_setting', 'can_edit')) {
                            ?>
                                <li><a href="<?php echo site_url('admin/addPsycomotor.php'); ?>"><i class="fa fa-angle-double-right"></i> Psycomotor Setting</a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('grading_list', 'can_view')) {
                            ?>
                                <li><a href="<?php echo site_url('admin/gradingList.php'); ?>"><i class="fa fa-angle-double-right"></i> Grading List</a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('compute_affective_domain', 'can_edit')) {
                            ?>
                                <li><a href="<?php echo base_url(); ?>admin/affectiveDomain.php"><i class="fa fa-angle-double-right"></i> Affective Domain</a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('compute_psycomotor', 'can_edit')) {
                            ?>
                                <li><a href="<?php echo base_url(); ?>admin/psycomotor.php"><i class="fa fa-angle-double-right"></i> Psycomotor</a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('compute_result', 'can_view')) {
                            ?>
                                <li><a href="<?php echo base_url(); ?>admin/computeExam.php"><i class="fa fa-angle-double-right"></i> Compute Result</a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('british_computation', 'can_view')) {
                            ?>
                            ...
                            if ($this->rbac->hasPrivilege('Head_teacher_manual_comment', 'can_view')) {
                            ?>
                                <li><a href="<?php echo base_url(); ?>admin/schoolHeadManualComment.php"><i class="fa fa-angle-double-right"></i> Head Teacher's Manual Comment</a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('teachers_default_comment', 'can_view')) {
                            ?>
                                <li><a href="<?php echo site_url('admin/settingTeacherDefaultComments.php'); ?>"><i class="fa fa-angle-double-right"></i> Teachers's Default Comment</a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('teachers_manual_comment', 'can_view')) {
                            ?>
                                <li><a href="<?php echo base_url(); ?>admin/settingTeacherManualComment.php"><i class="fa fa-angle-double-right"></i> Teachers's Manual Comment</a></li>
                            <?php
                            }

                            if ($this->rbac->hasPrivilege('resumption_date', 'can_view')) {
                            ?>
                                <li><a href="<?php echo base_url(); ?>admin/schoolResumptionDate.php"><i class="fa fa-angle-double-right"></i> Resumption Date</a></li>
                            <?php
                            }
                            if ($this->rbac->hasPrivilege('results', 'can_view')) {
                            ?>
                                <li><a href="<?php echo site_url('admin/examResult.php'); ?>"><i class="fa fa-angle-double-right"></i> Results</a></li>
                            <?php
                            }

                            if ($this->rbac->hasPrivilege('broadsheet', 'can_view')) {
                            ?>
                                <li><a href="<?php echo base_url(); ?>admin/broadsheet.php"><i class="fa fa-angle-double-right"></i> BroadSheet</a></li> <?php } ?>
                    ...
                    <li class="treeview <?php echo set_Topmenu('Academics'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <?php if ($this->rbac->hasPrivilege('class_timetable', 'can_view')) { ?>
                                ...
                                <li class="<?php echo set_Submenu('Academics/subjecttable'); ?>"><a href="<?php echo base_url(); ?>admin/subjecttable/classreport"><i class="fa fa-angle-double-right"></i> Subject Teacher</a></li>
