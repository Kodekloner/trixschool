...
<head>
    ...
    <style>
        ...
        .product-description { display: block; color: #777; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; }
    ...
    <div class="row">
        <div class="paddtop20">
            <div class="col-md-8 col-md-offset-2 text-center">
                <img src="https://schoollift.s3.us-east-2.amazonaws.com/uploads/school_content/logo/<?php echo htmlspecialchars($setting[0]['image'], ENT_QUOTES, 'UTF-8'); ?>" alt="School logo">
            </div>
            ...
            <div class="col-md-6 col-md-offset-3 mt20">
                <div class="paymentbg">
                    ...
                    <br>
                    <?php if ($api_error !== '') { ?>
                        <div class="alert alert-danger"><?php echo htmlspecialchars($api_error, ENT_QUOTES, 'UTF-8'); ?></div>
                    <?php } ?>
                    <div class="padd2 paddtzero">
                        <form action="<?php echo base_url('students/monnify/pay'); ?>" method="post">
                            <table class="table2" width="100%">
                                <tr>
                                    <th><?php echo $this->lang->line('description'); ?></th>
                                    <th class="text-right"><?php echo $this->lang->line('amount'); ?></th>
                                </tr>
                                <?php foreach ($student_fees_master_array as $fees_value) { ?>
                                    <tr>
                                        <td>
                                            <span class="title"><?php echo htmlspecialchars($fees_value['fee_group_name'], ENT_QUOTES, 'UTF-8'); ?></span>
                                            <span class="product-description"><?php echo htmlspecialchars($fees_value['fee_type_code'], ENT_QUOTES, 'UTF-8'); ?></span>
                                        </td>
                                        <td class="text-right"><?php echo $setting[0]['currency_symbol'] . number_format((float) $fees_value['amount_balance'], 2, '.', ''); ?></td>
                                    </tr>
                                    <tr class="border_bottom">
                                        <td><span class="text-fine"><?php echo $this->lang->line('fine'); ?></span></td>
                                ...
                                <tr class="bordertoplightgray">
                                    ...
                                    <td bgcolor="#fff" class="text-right"><input type="email" class="form-control" name="email" value="<?php echo set_value('email', $student_data['guardian_email']); ?>"></td>
                                </tr>
                                <tr class="bordertoplightgray">
