...
if (!empty($student['image'])) {
    ...
    ?>" alt="User profile picture">
                            ...
                            <div class="col-md-12 mb10">
								...
								<a href="?term=all" class="btn btn-sm btn-success" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><i class="fa fa-print"></i>View All Fee </a>
								<a href="?" class="btn btn-sm btn-warning" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Please Wait.."><i class="fa fa-print"></i> View current Fee </a>
