...
class Teacher_model extends CI_Model {
    ...
    public function get_subjectby_classid2($class_id, $section_id, $staff_id) {

        $query = $this->db->query("select GROUP_CONCAT(st.subject_group_subject_id) as subject from subjecttables st where st.staff_id='" . $staff_id . "' and class_id='" . $class_id . "' and section_id='" . $section_id . "' and st.session_id='" . $this->current_session . "'  group by staff_id ");
        return $query = $query->row_array();
    }
