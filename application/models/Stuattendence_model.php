...
class Stuattendence_model extends MY_Model
{
    ...
    {
        $this->db->select('student_session.id as student_session_id, students.id as student_id, students.firstname, students.lastname, students.middlename, students.roll_no, students.admission_no');
